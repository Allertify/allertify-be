    ...
    schemas: {
      ...
      ProductReport: {
        ...
        properties: {
          ...
          report_details: {
            type: 'string',
            example: 'Incorrect ingredient information',
          },
          status: {
            type: 'string',
  ...
  paths: {
    ...
    '/users/me/allergies': {
      get: {
        ...
        security: [{ bearerAuth: [] }],
        responses: {
          '200': { description: 'Allergies retrieved' },
          '401': { $ref: '#/components/responses/Unauthorized' },
        },
      },
      put: {
            ...
            'application/json': {
              schema: {
                ...
                properties: {
                  allergies: {
                    type: 'array',
                    items: { type: 'string', example: 'peanut' },
                  },
                },
              },
            },
        ...
        responses: {
          '200': { description: 'Allergies updated' },
          '401': { $ref: '#/components/responses/Unauthorized' },
        },
      },
    },
    ...
    '/scans/history': {
      get: {
        ...
        description:
          'Mendapatkan riwayat scan user dengan pagination dan filter',
        security: [{ bearerAuth: [] }],
        parameters: [
          {
            name: 'limit',
          ...
          },
          {
            ...
            schema: { type: 'boolean', default: false },
            description:
              'Tampilkan hanya produk unik (scan terbaru per produk)',
          },
          {
            name: 'listType',
            in: 'query',
              ...
              schema: {
                ...
                properties: {
                  ...
                  listType: {
                    ...
                    enum: ['RED', 'GREEN'],
                    description:
                      'Tipe list (RED untuk tidak suka, GREEN untuk suka)',
                  },
                  ...
                  properties: {
                    ...
                    data: {
                      ...
                      properties: {
                        reports: {
                          type: 'array',
                          items: { $ref: '#/components/schemas/ProductReport' },
                        },
                        pagination: { $ref: '#/components/schemas/Pagination' },
                      },
                    },
    ...
    '/products/{productId}/report': {
      post: {
              ...
              schema: {
                ...
                properties: {
                  report_details: {
                    ...
                    maxLength: 255,
                    example:
                      'Incorrect ingredient information listed on this product',
                  },
                },
              },
            },
        ...
        responses: {
          '201': { description: 'Product report submitted successfully' },
          '400': { description: 'Validation error or invalid product ID' },
          '401': { $ref: '#/components/responses/Unauthorized' },
          '404': { description: 'Product not found' },
          '409': { description: 'User has already reported this product' },
        },
      },
    },
    // Subscriptions
                  ...
                  properties: {
                    ...
                    data: {
                      ...
                      properties: {
                        plans: {
                          type: 'array',
                          items: { $ref: '#/components/schemas/TierPlan' },
                        },
                      },
                    },
                  },
    ...
    '/subscriptions/me/limits': {
      get: {
        ...
        security: [{ bearerAuth: [] }],
        responses: {
          '200': { description: 'Subscription limits retrieved successfully' },
          '401': { $ref: '#/components/responses/Unauthorized' },
        },
      },
    },
    '/subscriptions/upgrade': {
      post: {
        ...
        responses: {
          '201': { description: 'Subscription upgraded successfully' },
          '400': { description: 'Validation error' },
          '401': { $ref: '#/components/responses/Unauthorized' },
          '404': { description: 'Tier plan not found' },
        },
      },
    },
    // Admin
    ...
    '/admin/analytics': {
      get: {
        ...
        security: [{ bearerAuth: [] }],
        responses: {
          '200': { description: 'System analytics retrieved successfully' },
          '401': { $ref: '#/components/responses/Unauthorized' },
          '403': { $ref: '#/components/responses/Forbidden' },
        },
      },
    ...
    '/admin/users/{userId}': {
      ...
      put: {
        ...
        responses: {
          ...
          '400': { description: 'Validation error or invalid user ID' },
          '401': { $ref: '#/components/responses/Unauthorized' },
          '403': { $ref: '#/components/responses/Forbidden' },
          '404': { description: 'User not found' },
        },
    ...
    '/admin/reports': {
      get: {
        ...
        responses: {
          '200': { description: 'Product reports retrieved successfully' },
          '401': { $ref: '#/components/responses/Unauthorized' },
          '403': { $ref: '#/components/responses/Forbidden' },
        },
      },
    ...
    '/admin/reports/{reportId}': {
      put: {
        ...
        responses: {
          ...
          '400': { description: 'Validation error or invalid report ID' },
          '401': { $ref: '#/components/responses/Unauthorized' },
          '403': { $ref: '#/components/responses/Forbidden' },
    ...
    '/admin/allergens': {
      get: {
        ...
        responses: {
          '200': { description: 'Allergens retrieved successfully' },
          '401': { $ref: '#/components/responses/Unauthorized' },
          '403': { $ref: '#/components/responses/Forbidden' },
        },
      },
      post: {
        ...
        responses: {
          '201': { description: 'Allergen created successfully' },
          '401': { $ref: '#/components/responses/Unauthorized' },
          '403': { $ref: '#/components/responses/Forbidden' },
        },
      },
    ...
    '/admin/allergens/{id}': {
      put: {
        ...
        responses: {
          '200': { description: 'Allergen updated successfully' },
          '401': { $ref: '#/components/responses/Unauthorized' },
          '403': { $ref: '#/components/responses/Forbidden' },
        },
      },
      delete: {
        ...
        responses: {
          '200': { description: 'Allergen deleted successfully' },
          '401': { $ref: '#/components/responses/Unauthorized' },
          '403': { $ref: '#/components/responses/Forbidden' },
        },
      },
