    ...
    try {
      ...
      if (!userAllergies || userAllergies.length === 0) {
        ...
        return {
          ...
          matchedAllergens: [],
          reasoning:
            'No allergies specified by user, product is considered safe.',
        };
      }
    ...
    try {
      ...
      if (process.env.BYPASS_AI === 'true') {
        return {
          ...
          matchedAllergens: [],
          reasoning:
            '🤖 AI BYPASSED - Image analysis requires AI service. Set BYPASS_AI=false to enable real AI analysis.',
        };
      }
...
Provide a thorough but concise reasoning that explains your decision.
      ...
      if (process.env.BYPASS_AI === 'true') {
        ...
        return {
          ...
          matchedAllergens: [],
          reasoning:
            '🤖 AI BYPASSED - Image analysis failed. Set BYPASS_AI=false to enable real AI analysis.',
        };
      }
...
Provide a thorough but concise reasoning that explains your decision.
      ...
      throw new Error(
        'Unknown error occurred during AI uploaded image analysis',
      );
    }
  }
  ...
  async analyzeIngredientsWithContext(
    ...
    try {
      ...
      if (context.productName)
        contextInfo.push(`Product: ${context.productName}`);
